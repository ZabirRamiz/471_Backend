...
class property(models.Model):
    ...
    agent_id = models.ForeignKey(employee, related_name = 'property_agent',  on_delete=models.CASCADE, null = True)
    support_id = models.ForeignKey(employee,  related_name = 'property_support', on_delete=models.CASCADE, null = True)
